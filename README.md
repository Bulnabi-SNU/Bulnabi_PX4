...
### 기체에 펌웨어를 업로드 하는 방법
px4를 직접 건드리는 팀이 아니라도, 기체에 펌웨어를 업로드 하는 부분은 알고 있어야 한다. 위의 과정을 따라 Bulnabi_PX4를 설치한 했다면, 그것을 픽스호크 위에 올린 뒤에 본인들의 작업물(Companion computer활용한 부분 포함)과 충돌이 일어나지는 않는지 확인해야 한다.
